...
if (!text) throw `Use example ${usedPrefix}${command} 💝 Dinuwa Official²⁰²³ 💝`
  let vid = (await youtubeSearch(text)).video[0]
  if (!vid) throw 'Video/Audio Tidak Ditemukan'
...
💝 *Views:* ${viewH}
  ...
  let msg = await conn.sendMessage(m.chat, { image: { url: thumbnail }, caption: capt, footer: 'Follow me on Github:\n\tgithub.com/dinuwah/Dinuwa-Official-USER-BOT-V3', buttons }, { quoted: m })
